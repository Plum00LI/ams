...
import ams.dao.IAmsGradeDao;
import ams.service.IAmsGradeService;
...
@Service
public class AmsGradeService implements IAmsGradeService {

	
	private IAmsGradeDao dao;

	@Autowired
	public AmsGradeService(IAmsGradeDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "科目考试ID", "学生ID", "分数", "创建人", "创建时间"};
