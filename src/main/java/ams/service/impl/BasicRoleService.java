...
import ams.dao.IBasicRoleDao;
import ams.service.IBasicRoleService;
...
@Service
public class BasicRoleService implements IBasicRoleService {

	
	private IBasicRoleDao dao;

	@Autowired
	public BasicRoleService(IBasicRoleDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "角色CODE代码", "角色名称", "角色备注", "创建人", "创建时间"};
