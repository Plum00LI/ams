...
import ams.dao.IBasicRoutDao;
import ams.service.IBasicRoutService;
...
@Service
public class BasicRoutService implements IBasicRoutService {

	
	private IBasicRoutDao dao;

	@Autowired
	public BasicRoutService(IBasicRoutDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "路由名称", "路由地址", "图标", "创建人", "创建时间"};
