...
import ams.dao.IBasicRoutPermissionDao;
import ams.service.IBasicRoutPermissionService;
...
@Service
public class BasicRoutPermissionService implements IBasicRoutPermissionService {

	
	private IBasicRoutPermissionDao dao;

	@Autowired
	public BasicRoutPermissionService(IBasicRoutPermissionDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "权限ID", "路由ID", "创建人", "创建时间"};
