...
import ams.dao.IAmsExamItemDao;
import ams.service.IAmsExamItemService;
...
@Service
public class AmsExamItemService implements IAmsExamItemService {

	
	private IAmsExamItemDao dao;

	@Autowired
	public AmsExamItemService(IAmsExamItemDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "考试ID", "科目ID", "参考人数", "考试时间", "创建人", "创建时间"};
