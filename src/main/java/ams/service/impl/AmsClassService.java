...
import ams.dao.IAmsClassDao;
import ams.service.IAmsClassService;
...
@Service
public class AmsClassService implements IAmsClassService {

	
	private IAmsClassDao dao;

	@Autowired
	public AmsClassService(IAmsClassDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "课程代码", "课程名", "课程类型", "学分", "学时", "创建人", "创建时间"};
