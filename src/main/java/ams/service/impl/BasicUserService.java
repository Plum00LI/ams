...
import ams.dao.IBasicUserDao;
import ams.service.IBasicUserService;
...
public class BasicUserService implements IBasicUserService {
	...
	private IBasicUserDao dao;

	@Autowired
	public BasicUserService(IBasicUserDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "姓名", "手机", "创建人", "创建时间"};
