...
import ams.dao.IBasicAccountDao;
import ams.service.IBasicAccountService;
...
public class BasicAccountService implements IBasicAccountService {
	...
	private IBasicAccountDao dao;

	@Autowired
	public BasicAccountService(IBasicAccountDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "用户ID", "登录账号", "账号类别", "创建人", "创建时间"};
