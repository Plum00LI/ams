...
import ams.dao.IBasicMajorDao;
import ams.service.IBasicMajorService;
...
@Service
public class BasicMajorService implements IBasicMajorService {

	
	private IBasicMajorDao dao;

	@Autowired
	public BasicMajorService(IBasicMajorDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "学院ID", "专业代码", "备注", "创建人", "创建时间"};
