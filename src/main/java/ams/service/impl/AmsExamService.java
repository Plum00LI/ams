...
@Service
public class AmsExamService implements IAmsExamService {

	
	private IAmsExamDao dao;

	@Autowired
	public AmsExamService(IAmsExamDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "考期ID", "考试名", "考试时间", "创建人", "创建时间"};
