...
import ams.dao.IAmsExamDateDao;
import ams.service.IAmsExamDateService;
...
@Service
public class AmsExamDateService implements IAmsExamDateService {

	
	private IAmsExamDateDao dao;

	@Autowired
	public AmsExamDateService(IAmsExamDateDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "考期名", "考期代码", "创建人", "创建时间"};
