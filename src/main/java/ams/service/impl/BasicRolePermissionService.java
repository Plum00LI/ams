...
import ams.dao.IBasicRolePermissionDao;
import ams.service.IBasicRolePermissionService;
...
@Service
public class BasicRolePermissionService implements IBasicRolePermissionService {

	
	private IBasicRolePermissionDao dao;

	@Autowired
	public BasicRolePermissionService(IBasicRolePermissionDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "角色ID", "权限ID", "创建人", "创建时间"};
