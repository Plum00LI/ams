...
import ams.dao.IBasicDepartDao;
import ams.service.IBasicDepartService;
...
@Service
public class BasicDepartService implements IBasicDepartService {

	
	private IBasicDepartDao dao;

	@Autowired
	public BasicDepartService(IBasicDepartDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "学院名称", "学院代码", "备注", "创建人", "创建时间"};
