...
import ams.dao.IBasicUserRoleDao;
import ams.service.IBasicUserRoleService;
...
@Service
public class BasicUserRoleService implements IBasicUserRoleService {

	
	private IBasicUserRoleDao dao;

	@Autowired
	public BasicUserRoleService(IBasicUserRoleDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "用户ID", "角色ID", "创建人", "创建时间"};
