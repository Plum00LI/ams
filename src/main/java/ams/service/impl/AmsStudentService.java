...
import ams.dao.IAmsStudentDao;
import ams.service.IAmsStudentService;
...
@Service
public class AmsStudentService implements IAmsStudentService {

	
	private IAmsStudentDao dao;

	@Autowired
	public AmsStudentService(IAmsStudentDao dao) {
		this.dao = dao;
	}
	...
	public void exportExcel(Map<String, Object> paramMap, HttpServletResponse response) {
		...
		// 获取头部信息
		String[] headList = new String[] { "用户ID", "学号", "性别", "年龄", "专业ID", "学院ID", "创建人", "创建时间"};
