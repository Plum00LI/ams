...
@Api(tags = "basicRout接口")
@RequestMapping("/basicRout")
public class BasicRoutController {

	
	private IBasicRoutService service;

	@Autowired
	public BasicRoutController(IBasicRoutService service) {
