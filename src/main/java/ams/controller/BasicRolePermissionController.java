...
@Api(tags = "basicRolePermission接口")
@RequestMapping("/basicRolePermission")
public class BasicRolePermissionController {

	
	private IBasicRolePermissionService service;

	@Autowired
	public BasicRolePermissionController(IBasicRolePermissionService service) {
