...
@Api(tags = "amsTeacher接口")
@RequestMapping("/amsTeacher")
public class AmsTeacherController {

	
	private IAmsTeacherService service;

	@Autowired
	public AmsTeacherController(IAmsTeacherService service) {
