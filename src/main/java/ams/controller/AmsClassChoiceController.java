...
@Api(tags = "amsClassChoice接口")
@RequestMapping("/amsClassChoice")
public class AmsClassChoiceController {

	
	private IAmsClassChoiceService service;

	@Autowired
	public AmsClassChoiceController(IAmsClassChoiceService service) {
