...
@Api(tags = "basicRoutPermission接口")
@RequestMapping("/basicRoutPermission")
public class BasicRoutPermissionController {

	
	private IBasicRoutPermissionService service;

	@Autowired
	public BasicRoutPermissionController(IBasicRoutPermissionService service) {
