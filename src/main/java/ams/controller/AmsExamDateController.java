...
@Api(tags = "amsExamDate接口")
@RequestMapping("/amsExamDate")
public class AmsExamDateController {

	
	private IAmsExamDateService service;

	@Autowired
	public AmsExamDateController(IAmsExamDateService service) {
