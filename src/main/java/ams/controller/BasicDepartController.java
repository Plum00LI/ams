...
@Api(tags = "basicDepart接口")
@RequestMapping("/basicDepart")
public class BasicDepartController {

	
	private IBasicDepartService service;

	@Autowired
	public BasicDepartController(IBasicDepartService service) {
