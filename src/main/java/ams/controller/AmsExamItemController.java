...
@Api(tags = "amsExamItem接口")
@RequestMapping("/amsExamItem")
public class AmsExamItemController {

	
	private IAmsExamItemService service;

	@Autowired
	public AmsExamItemController(IAmsExamItemService service) {
