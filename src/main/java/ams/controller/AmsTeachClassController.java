...
@Api(tags = "amsTeachClass接口")
@RequestMapping("/amsTeachClass")
public class AmsTeachClassController {

	
	private IAmsTeachClassService service;

	@Autowired
	public AmsTeachClassController(IAmsTeachClassService service) {
